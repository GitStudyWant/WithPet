...
<body>
	...
	<div id="body">
        <div id="wrap">
            ...
            <div style="width: 60%; margin: auto;">
				<form method="post" action="insert.free" enctype="multipart/form-data" id="boardInsert" onsubmit="getTags()">
					...
					<div align="center">
						...
						<br><br>
	                    <button type="submit" class="btn btn-primary" form="boardInsert">등록하기</button>
    ...
    <script>	
			    ...
			    function getTags() {
			        var tags = [];
			        $('.tag-list-board .tag-item').each(function() {
			            tags.push($(this).text().trim());
			        });

			        $('#tagBridge').html('<input type="hidden" name="tags" value="' + JSON.stringify(tags) + '">');
			    }
